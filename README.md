...
1. Download and install [JUCE and the Projucer](https://juce.com/download/) (once i learn CMake, this will not be necessary).
2. In the Projuces, open `crackedGlass.jucer`, and click `Save and open in IDE`.
